      ...
      try {
        ...
        if (lastStep && lastStep.end) {
          ...
          if (data.currentStep.user) {
            ...
            //To reproduce, refresh during bot output delay
            ...
            const cpDifferent = (data.currentStep.id !== data.previousStep.id);
            const lrlpMatch   = (lastRenderedStep.id === lastPreviousStep.id);
            const clrMatch    = (data.currentStep.id === lastRenderedStep.id);
            if (cpDifferent && lrlpMatch && clrMatch) {
              console.info("Recovering from interrupted step transition")
